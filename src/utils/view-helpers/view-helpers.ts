import { AdminJSFrontendOptions, Assets } from '../../interfaces/admin-options'
...
export class ViewHelpers {
  ...
  constructor(options?: AdminJSFrontendOptions) {
  ...
  static getPaths(options?: AdminJSFrontendOptions): Paths {
