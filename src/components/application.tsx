    ...
    <>
      ...
      <Box height="100%" flex>
        ...
        <Box flex flexGrow={1} flexDirection="column" overflowY="auto" bg="bg">
          ...
          <Routes>
            <Route path={h.dashboardUrl()} element={Dashboard as any} />
            <Route path={resourceUrl} element={Resource as any} />
            <Route path={pageUrl} element={Page as any} />
          </Routes>
          <Routes>
            <Route path={recordActionUrl} element={RecordAction as any} />
            <Route path={resourceActionUrl} element={ResourceAction as any} />
            <Route path={bulkActionUrl} element={BulkAction as any} />
          </Routes>
        </Box>
      </Box>
    </>
