 ...
 * @private
 */
const BulkDeleteComponent: React.FC<ActionProps & AddNoticeProps> = (props) => {
...
export const FormattedBulkDelete = withNotice(withRouter(BulkDeleteComponent))
export const BulkDelete = FormattedBulkDelete

export default FormattedBulkDelete
